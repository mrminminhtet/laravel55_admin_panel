				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							&emsp;
							<a href="{{url('admin/user/'.$user->id.'/edit')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o"></i></a>
							&emsp;
							<form action="{{url('admin/user/'.$user->id)}}" method="POST" class="form-delete" style="display: inline;"> 
							{{csrf_field()}}
							<button class="btn btn-danger btn-xs" type="submit"><span class="fa fa-trash-o"></span></button>
						</form>
						</td>
						@endadmin
					</tr>
